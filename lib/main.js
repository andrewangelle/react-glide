...
/******/ 	}
/******/ 	var parentHotUpdateCallback = window["webpackHotUpdatereactGlide"];
/******/ 	window["webpackHotUpdatereactGlide"] = // eslint-disable-next-line no-unused-vars
...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "a313b1a8fbd6a84151c2";
...
/******/
/******/ 	var jsonpArray = window["webpackJsonpreactGlide"] = window["webpackJsonpreactGlide"] || [];
...
function (_React$Component) {
  ...
  function Glide() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "autoPlay", void 0);
  ...
  _createClass(Glide, [{
    ...
    key: "goToSelectedDot",
    value: function goToSelectedDot(index) {
      this.setState({
        currentIndex: index
      });
    }
    ...
    value: function goToPrevSlide() {
      ...
      var nextIndex = currentIndex === 0 ? children.length - 1 : currentIndex - 1;
      this.setState({
    ...
    value: function componentWillUpdate(nextProps, nextGlideState) {
      var currentIndex = this.state.currentIndex;
      var onSlideChange = this.props.onSlideChange;
      var willIndexChange = currentIndex !== nextGlideState.currentIndex;
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.toArray(children)[currentIndex]), (infinite || currentIndex !== 0) && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        className: "glide--prev-btn",
        onClick: function onClick() {
          clearInterval(_this3.autoPlay);

          _this3.goToPrevSlide();
        }
      }, "\u276E"), (infinite || currentIndex !== children.length - 1) && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        className: "glide--next-btn",
        onClick: function onClick() {
          clearInterval(_this3.autoPlay);

          _this3.goToNextSlide();
        }
      }, "\u276F"), dots && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
